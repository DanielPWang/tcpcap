...
// enum HTTP_TRANSFER_FLAGS { HTTP_TRANSFER_NONE, HTTP_TRANSFER_HAVE_CONTENT_LENGTH, HTTP_TRANSFER_CHUNKED, HTTP_TRANSFER_OTHER, HTTP_TRANSFER_FILE };
...
// enum HTTP_APPEND_STATUS { HTTP_APPEND_FAIL= -1, HTTP_APPEND_ADD_PACKET = 0, HTTP_APPEND_ADD_PACKET_LATER, HTTP_APPEND_FINISH_LATER, HTTP_APPEND_FINISH_CURRENT, HTTP_APPEND_SUCCESS, HTTP_APPEND_REUSE };

// enum HTTP_SESSION_FINISH_TYPE { HTTP_SESSION_FINISH_SUCCESS, HTTP_SESSION_FINISH_TIMEOUT, HTTP_SESSION_FINISH_CHANNEL_REUSED, HTTP_SESSION_FINISH_UNKNOWN_DATA, HTTP_SESSION_FINISH_DISORDER_REBUILD_FAILED };
