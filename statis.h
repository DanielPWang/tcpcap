...
extern uint32_t whole_html_session_no_query;
extern uint32_t whole_html_session_no_http;
...
#define INC_WHOLE_HTML_SESSION_NOQUERY do{ ++whole_html_session_no_query; }while(0)
#define INC_WHOLE_HTML_SESSION_NOHTTP do{ ++whole_html_session_no_http; }while(0)
